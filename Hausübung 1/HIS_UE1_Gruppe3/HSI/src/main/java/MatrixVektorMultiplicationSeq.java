...
public class MatrixVektorMultiplicationSeq {

	static int matrixSize = 15000; // Assumption: square matrix
	int m, n;
	...
	public static void main(String args[]) {
		...
		MatrixVektorMultiplicationSeq op = new MatrixVektorMultiplicationSeq(rows, columns);
		op.initData();
		op.calc();
		op.printResults();
	...
	public MatrixVektorMultiplicationSeq(int m, int n) {
		this.m = m;
		this.n = n;
