...
public class Parallel {
	public static void main(String[] args) {
		...
		// data
		int m = 6;// Integer.parseInt(appArgs[0]);
		int n = 0;
		int i, j;
		int[][] a = new int[m][m];
		int[][] b = new int[m][m];
		...
		System.out.println("local final A" + rank + " :" + Arrays.deepToString(x));
		System.out.println("local final B" + rank + " :" + Arrays.deepToString(y));
		System.out.println("local final C" + rank + " :" + Arrays.deepToString(z));
		System.out.println("-------------------------------------");
